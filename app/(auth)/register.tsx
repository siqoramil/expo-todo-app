...
export default function RegisterScreen() {
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <LinearGradient
        colors={isDark
          ? ['#0B0D12', '#0D1A15', '#0B0D12']
          : ['#ECFDF5', '#E0FBF0', '#F4F5FA']
        }
        start={{ x: 0, y: 0 }}
        end={{ x: 1, y: 1 }}
      ...
      <FloatingOrb size={110} color={isDark ? '#10B98118' : '#10B98112'} x={-20} y={height * 0.12} delay={0} />
      <FloatingOrb size={70} color={isDark ? '#34D39915' : '#34D39910'} x={width - 50} y={height * 0.18} delay={400} />
      <FloatingOrb size={90} color={isDark ? '#10B98112' : '#10B98108'} x={width * 0.2} y={height * 0.78} delay={700} />
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Register Button */}
            <Animated.View entering={FadeInDown.delay(600).duration(400)} style={[btnStyle, { marginTop: 12 }]}>
              <Pressable
